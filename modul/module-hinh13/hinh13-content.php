                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-1.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-2.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-3.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-4.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-5.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-6.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-7.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
                    ...
                    <div class="col-inner">
                        <a href="#" class="plain ">
                            <div class="portfolio-box box has-hover">
                                <div class="box-image">
                                    <div class="image">
                                        <img class="img-responsive img" src="./images/hinh13-8.jpg">                                                
                                    </div>
                                </div><!-- box-image -->
                                <div class="box-text text-center">
                                    <div class="box-text-inner">
