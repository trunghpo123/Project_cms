...
<html lang="en">
    <head>
        ...
        <link href="../14/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="../14/css/font-awesome.min.css">
        <?php
        if (!class_exists('lessc')) {
        ...
        $less->compileFile('less/14.less', 'css/14.css');
        ?>
        <link href="../14/css/14.css" rel="stylesheet" type="text/css" />
    </head>
