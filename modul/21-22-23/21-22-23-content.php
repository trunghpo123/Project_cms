            ...
            <div class="col-md-9">
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="./images/blog-header2-1000x625.jpg">
                            </a>
                            <div class="date-img">
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="./images/blog-header31-1000x625.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="./images/breezi_placeit-1000x666.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="./images/Untitled-3-1000x649.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
