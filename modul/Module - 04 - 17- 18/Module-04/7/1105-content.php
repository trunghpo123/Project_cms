        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <!-- Hình 1 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/1.jpeg" alt="Bags">
                        <!-- box-image -->
                    ...
                    <!-- Hình 2 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/2.jpg" alt="Booking">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                    ...
                    <!-- Hình 3 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/3.jpg" alt="Clothing">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                    ...
                    <!-- Hình 4 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/4.jpeg" alt="Men">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                ...
                <!-- Hình 5 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/5.jpg" alt="Music">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                    ...
                    <!-- Hình 6 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/6.jpg" alt="Posters">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                    ...
                    <!-- Hình 7 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/7.jpg" alt="Shoes">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
                    ...
                    <!-- Hình 8 -->
                        <a href="#">
                        <img clas="lazy-active" src="../7/images/8.jpeg" alt="Women">
                        <!-- box-image -->
                        <div class="box-text text-center">
                            <div class="box-text-inner">
