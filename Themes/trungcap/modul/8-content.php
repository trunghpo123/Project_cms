        ...
        <div class="row row-footer-1">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 column">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-1.jpeg" alt="hinh1">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-2.jpeg" alt="hinh2">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-3.jpeg" alt="hinh3">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-4.jpeg" alt="hinh4">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 column">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-5.jpeg" alt="hinh5">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-6.jpeg" alt="hinh1">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-7.jpeg" alt="hinh1">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 column">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-8.jpeg" alt="hinh4">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 column">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-9.jpeg" alt="hinh1">
                ...
                <ul class="product-list">
                    <li>
                        <a href="#">
                            <img src="<?php echo(get_template_directory_uri()); ?>/images/hinh8-10.jpg" alt="hinh1">
