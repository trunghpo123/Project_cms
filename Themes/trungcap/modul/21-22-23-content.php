...
<div class="type-11">
        ...
        <div class="row">
            <div class="backround-img">
                <div class="load" style="background-image: url(<?php echo(get_template_directory_uri()); ?>/images/photo-1456324463128-7ff6903988d8-1000x667.jpeg);"></div>
                <div class="img-text">
                    <div class="fill"></div>
                    <div class="bog-text">
                        ...
                        <div class="bog-icon">
                            ...
                            <a class="button" href="#"><i class="fa fa-address-book" aria-hidden="true"></i></a>
                            <a class="button" href="#"><i class="fa fa-envelope"></i></a>
                            <a class="button" href="#"><i class="fa fa-heart"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="<?php echo(get_template_directory_uri()); ?>/images/blog-header2-1000x625.jpg">
                            </a>
                            <div class="date-img">
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="<?php echo(get_template_directory_uri()); ?>/images/blog-header31-1000x625.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="<?php echo(get_template_directory_uri()); ?>/images/12738.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="<?php echo(get_template_directory_uri()); ?>/images/breezi_placeit-1000x666.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
			...
			Posted in 
                ...
                <div class="post-new">
                    <header class="entry-header">
                        ...
                        <div class="img-blog1">
                            <a href="#">
                                <img src="<?php echo(get_template_directory_uri()); ?>/images/Untitled-3-1000x649.jpg">
                            </a>
                            <div class="date-img">
                                <span class="post-date-day">13</span><br>
		                <span class="post-date-month">Oct</span>
